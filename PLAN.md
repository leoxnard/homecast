...
| **Zoom** | FOV-based. Limits **computed** from file resolution × window size: ~110° max out, ~2× upscale max in. A **"1:1 native" badge** lights at exact pixel mapping. A modifier key **overrides past the clamps**. |
